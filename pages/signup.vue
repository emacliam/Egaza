  ...
  <main>
    ...
    >
      ...
      >
        ...
        <button
          class="relative mt-6 border rounded py-2 text-sm text-gray-800 bg-gray-100 hover:bg-gray-200"
        >
          <span
            ...
            <div class="flex flex-col mb-6">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  type="email"
                  name="email"
                  class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"
